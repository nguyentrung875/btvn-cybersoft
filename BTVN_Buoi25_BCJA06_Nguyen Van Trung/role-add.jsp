...
<body>
			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form class="form-horizontal form-material" id="formAddRole">
								...
								<div class="form-group">
									<div class="col-sm-12">
										<button type="submit" class="btn btn-success" id="btnAddRole">Add
											Role</button>
	...
	<script>
		$("#formAddRole").submit(function(e) {
			e.preventDefault();
			$.ajax({
				url : window.location.origin + "/crm06/role-add",
				type : "POST",
